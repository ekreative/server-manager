 ...
 */
class Version20170228154052 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE site ADD status VARCHAR(60) NOT NULL, DROP responsibility');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE site ADD responsibility TINYINT(1) NOT NULL, DROP status');
    }
}
